...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center my-4">
            <h2 class="font-weight-bold m-0">{{ $questions[0]->session->type->name }}</h2>
                                    ...
                                    <td class="justify-content-center">
                                        @if($question->question === null)
                                            ...
                                            @else
                                                <img
                                                    id="preview-image-before-upload"
                                                    src="{{ Storage::get('images/question/' . $question->session->type->name . '/' . $question->session->session . '/' . $question->image . '.png') }}"
                                                    style="max-height: 500px;"
                                                    alt="question_image"
                                                >
                                            @endif
